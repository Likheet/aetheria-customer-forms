...
const HairReactions: React.FC<StepProps> = ({ formData, updateFormData, onNext, onBack }) => {
  return (
    <FormStep
      title="Have you had any reactions to hair treatments or products before?"
      onNext={onNext}
      onBack={onBack}
    >
      <div className="space-y-4">
        ...
        <div>
          <textarea
            value={formData.hairReactions}
            onChange={(e) => updateFormData({ hairReactions: e.target.value })}

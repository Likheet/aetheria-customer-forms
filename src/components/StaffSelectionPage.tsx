...
import { Star, ClipboardList, PenSquare } from "lucide-react";
  ...
  return (
    <div className="luxury-shell">
      ...
      <div className="luxury-page">
        ...
        <section className="relative z-10 mx-auto grid max-w-5xl gap-10 md:grid-cols-3">
          {options.map(({ id, label, description, icon: Icon, action }) => {
            ...
            return (
              <Card
                ...
                className="flex min-h-[260px] flex-col justify-between border-border/40 bg-surface/85 px-8 py-10 transition-transform duration-300 hover:-translate-y-1 hover:border-primary/45 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
              >
              <CardHeader className="gap-6 p-0">
                ...
                <div className="space-y-3">
                  <CardTitle className="text-[26px] font-semibold text-foreground">{label}</CardTitle>

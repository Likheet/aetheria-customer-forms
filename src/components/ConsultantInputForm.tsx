    ...
    return (
      <div className="luxury-shell">
        ...
        <div className="luxury-page-form items-center justify-center">
          <Card className="w-full border-border/50 bg-surface/85 text-center">
            <CardHeader className="items-center gap-4 p-12">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-primary/15 text-primary">
                <CheckCircle className="h-10 w-10" />
              </div>
              <CardTitle className="text-3xl md:text-4xl text-gradient-gold">Submission received</CardTitle>
              <CardDescription className="text-muted-foreground/80 text-base md:text-lg max-w-lg">
            ...
            <CardContent className="flex flex-col items-center gap-6 pt-0 pb-12">
              <p className="text-sm md:text-base text-muted-foreground/75">
    ...
    <div className="luxury-shell">
      ...
      <div className="luxury-page-form">
        <header className="relative z-10 flex flex-col gap-5">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="space-y-3">
              ...
              <h1 className="text-gradient-gold text-4xl md:text-5xl">Capture your expertise</h1>
            ...
            {treatmentType && currentStep > 2 ? (
              <div className="self-start rounded-full border border-border/40 bg-surface/70 px-5 py-2.5 text-xs uppercase tracking-[0.32em] text-muted-foreground/70">
                {treatmentType}
              </div>
            ) : null}
          </div>
          ...
          {showProgress ? (
            <div className="rounded-[20px] border border-border/50 bg-surface/75 p-6 shadow-luxury backdrop-blur">
              <ProgressBar
        ...
        <section className="relative z-10">
          <Card className="w-full border-border/50 bg-surface/90 shadow-xl">
            <CardContent className="p-0">{renderStep()}</CardContent>
          </Card>
        </section>

        <footer className="relative z-10 flex flex-col gap-1 text-xs uppercase tracking-[0.28em] text-muted-foreground/60 md:flex-row md:items-center md:justify-between">

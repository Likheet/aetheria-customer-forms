    ...
    return (
      <div className="luxury-shell">
        ...
        <div className="luxury-page-form items-center justify-center">
          <Card className="w-full border-border bg-surface/95 text-center shadow-md">
            <CardHeader className="items-center gap-6 p-12">
              ...
              <CardTitle className="text-3xl md:text-4xl font-semibold text-foreground">Submission received</CardTitle>
              <CardDescription className="text-muted-foreground text-base md:text-lg max-w-lg font-light">
            ...
            <CardContent className="flex flex-col items-center gap-6 pt-0 pb-12">
              <p className="text-sm md:text-base text-muted-foreground/75 font-light">
    ...
    <div className="luxury-shell">
      ...
      <div className="luxury-page-form">
        <header className="relative z-10 flex flex-col gap-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="space-y-3">
              ...
              <h1 className="text-foreground text-4xl md:text-5xl font-semibold">Capture your expertise</h1>
              <p className="max-w-2xl text-sm text-muted-foreground md:text-base font-light">
                Translate diagnostics into a refined narrative of care and progress for each guest.
              </p>
            </div>
            {treatmentType && currentStep > 2 ? (
              <div className="self-start rounded-full border border-border bg-surface/80 px-5 py-2 text-xs uppercase tracking-wider text-muted-foreground font-medium">
                {treatmentType}
              </div>
            ) : null}
          </div>
        ...
        <section className="relative z-10">
          <Card className="w-full border-border bg-surface/95 shadow-md">
            <CardContent className="p-0">{renderStep()}</CardContent>
          </Card>
        </section>

        <footer className="relative z-10 flex flex-col gap-2 text-xs tracking-wide text-muted-foreground/70 md:flex-row md:items-center md:justify-between font-light">
